...
exports.ActivityStateStateEnum = void 0;
/**
    * @export
    * @enum {string}
    */
var ActivityStateStateEnum;
(function (ActivityStateStateEnum) {
    ActivityStateStateEnum["New"] = "New";
    ActivityStateStateEnum["Initialized"] = "Initialized";
    ActivityStateStateEnum["Deployed"] = "Deployed";
    ActivityStateStateEnum["Ready"] = "Ready";
    ActivityStateStateEnum["Unresponsive"] = "Unresponsive";
    ActivityStateStateEnum["Terminated"] = "Terminated";
})(ActivityStateStateEnum = exports.ActivityStateStateEnum || (exports.ActivityStateStateEnum = {}));
