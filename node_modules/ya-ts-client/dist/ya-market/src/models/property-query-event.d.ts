...
import { PropertyQueryEventAllOf } from './property-query-event-all-of';
/**
 * @type PropertyQueryEvent
 * @export
 */
export declare type PropertyQueryEvent = Event & PropertyQueryEventAllOf;
