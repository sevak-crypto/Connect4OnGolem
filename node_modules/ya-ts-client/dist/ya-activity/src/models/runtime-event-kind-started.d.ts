 ...
 */
import { RuntimeEventKindStartedAllOf } from './runtime-event-kind-started-all-of';
/**
 * @type RuntimeEventKindStarted
 * @export
 */
export declare type RuntimeEventKindStarted = RuntimeEventKindStartedAllOf;
