 ...
 */
import { RuntimeEventKindStdErrAllOf } from './runtime-event-kind-std-err-all-of';
/**
 * @type RuntimeEventKindStdErr
 * @export
 */
export declare type RuntimeEventKindStdErr = RuntimeEventKindStdErrAllOf;
