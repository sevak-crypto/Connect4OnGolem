...
export declare const RequestorStateApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getRunningCommand: (activityId: string, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const RequestorStateApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getRunningCommand(activityId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ExeScriptCommandState>>>;
};
/**
...
export declare class RequestorStateApi extends BaseAPI implements RequestorStateApiInterface {
     ...
     * @memberof RequestorStateApi
     */
    getRunningCommand(activityId: string, options?: any): Promise<import("axios").AxiosResponse<ExeScriptCommandState[]>>;
}
