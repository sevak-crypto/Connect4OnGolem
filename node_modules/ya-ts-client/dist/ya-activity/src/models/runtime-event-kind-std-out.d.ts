 ...
 */
import { RuntimeEventKindStdOutAllOf } from './runtime-event-kind-std-out-all-of';
/**
 * @type RuntimeEventKindStdOut
 * @export
 */
export declare type RuntimeEventKindStdOut = RuntimeEventKindStdOutAllOf;
