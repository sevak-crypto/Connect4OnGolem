 ...
 */
import { RuntimeEventKindFinishedAllOf } from './runtime-event-kind-finished-all-of';
/**
 * @type RuntimeEventKindFinished
 * @export
 */
export declare type RuntimeEventKindFinished = RuntimeEventKindFinishedAllOf;
